...
// Per-sensor calibration (mV). Recalibrate against this specific probe.
...
const char* SENSOR_ID    = "lemon_moisture";
const char* SENSOR_NAME  = "Lemon Tree Moisture";
